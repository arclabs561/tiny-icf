...
class MultiTaskICF(nn.Module):
    ...
    def _extract_features(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if isinstance(self.base, UniversalICF):
            ...
            features = torch.cat([p3_max, p3_mean, p3_last, p5_max, p5_mean, p5_last, p7_max, p7_mean, p7_last], dim=1)
            return features
        else:
            ...
            raise NotImplementedError(f"Base model {type(self.base)} not supported for feature extraction")
